...
class MemoryTier3:
    ...
    def add_learned_behavior(self, event_type: str, suggestion: str, context: Dict[str, Any]) -> Dict[str, str]:
        """
    ...
    def add_to_blacklist(self, event_type: str, suggestion: str) -> Dict[str, str]:
        ...
        self.save()
        return {"status": "success", "message": f"Blacklisted: {event_type} → {suggestion}"}
